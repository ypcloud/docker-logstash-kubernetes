...
RUN /logstash/bin/logstash-plugin install logstash-filter-kubernetes
RUN /logstash/bin/logstash-plugin install logstash-input-journald
RUN /logstash/bin/logstash-plugin install --version 2.0.0.pre1 logstash-output-cloudwatchlogs
